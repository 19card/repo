//Translation for major components. Originally by Junesiphone, modified by Evelyn (@ev_ynw), modifed again bby Novinha//
...
if (Lang == "es") {
    var days = ["Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabados"];
    ...
    var hourtext = ["Doce", "Uno", "Dos", "Tres", "Cuatro", "Cinco", "Seis", "Siete", "Ocho", "Nueve", "Diez", "Once", "Doce", "Uno", "Dos", "Tres", "Cuatro", "Cinco", "Seis", "Siete", "Ocho", "Nueve", "Diez", "Once", "Doce"];
    var weatherdesc = ["Tornado", "Tormenta tropical", "Huracan", "Tormenta", "Tormenta", "Nieve", "Aguanieve", "Aguanieve", "Llovizna helada", "Llovizna", "Lluvia helada", "Chubascos", "Chubascos", "Rafagas", "Nieve", "Nieve", "Nieve", "Granizo", "Aguanieve", "Polvo", "Niebla", "Neblina", "Humo", "Tempestuoso", "Viento", "Frio", "Nublado", "Nublado", "Nublado", "Nublado", "Nublado", "Despejado", "Soleado", "Despejado", "Despejado", "Aguanieve", "Calor", "Tormentas", "Tormentas", "Tormentas", "Chubascos", "Nieve fuerte", "Nieve suave", "Nieve fuerte", "Parcialmente nublado", "Tormenta", "Nieve", "Tormenta", "Vacio"];
}
if (Lang == "cz") {
